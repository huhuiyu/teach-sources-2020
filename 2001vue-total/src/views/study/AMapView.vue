...
export default {
  ...
  mounted() {
    ...
    AMapLoader.load({
      ...
      plugins: ['AMap.Geocoder', 'AMap.Geolocation', 'AMap.Marker', 'AMap.Scale', 'AMap.ToolBar'], // 需要使用的的插件列表，如比例尺'AMap.Scale'等
    })
      .then((AMap) => {
        ...
        geolocation.getCurrentPosition((status, result) => {
          ...
          if ('complete' == status) {
            ...
            coder.getAddress(result.position, (s, r) => {
              logger.debug('逆地理编码信息：', s, r)
